...
(lib.Symbol1 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#000000").s().p("AhZgCIBZhIIBaBIIhaBNgAhFgCIBFA8IBGg8IhGg4g");
	this.shape.setTransform(255.1,57.7,1.605,1.605);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#000000").s().p("AhZgCIBZhIIBaBIIhaBNgAhFgCIBFA8IBGg8IhGg4g");
	this.shape_1.setTransform(14.4,57.7,1.605,1.605);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#000000").s().p("AqmAGIAAgLIVNAAIAAALg");
	this.shape_2.setTransform(135.7,57.2,1.605,1.605);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#000000").s().p("Ai2hCIAIgKICuCJICwiJIAIAKIi4CPg");
	this.shape_3.setTransform(98,68.8,1.605,1.605);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#000000").s().p("Ai2hCIAIgKICuCJICwiJIAIAKIi4CPg");
	this.shape_4.setTransform(171.6,68.8,1.605,1.605);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#000000").s().p("AkehvII9AAIkfDfgAAABgID5jCInxAAg");
	this.shape_5.setTransform(134.8,75.2,1.605,1.605);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.Symbol1, new cjs.Rectangle(0,45.6,269.6,47.6), null);
...
(lib.Mesas = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(47.6,47.5,0.746,0.747);
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(47.6,47.6,0.746,0.747);
	...
	this.instance_2.setTransform(47.6,47.6,0.746,0.747);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(1));

}).prototype = getMCSymbolPrototype(lib.Mesas, new cjs.Rectangle(0.1,0,95.1,95.1), null);
...
(lib.mobile = function(mode,startPosition,loop) {
	...
	// FlashAICB
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#000000").s().p("AhPAAIBPg9IBQA9IhQA+gAg/AAIA/AxIBAgxIhAgwg");
	this.shape.setTransform(65,385.7);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#000000").s().p("AhPAAIBPg9IBQA9IhQA+gAg/AAIA/AxIBAgxIhAgwg");
	this.shape_1.setTransform(685,385.7);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#000000").s().p("EgvNgADMBebgACIAAAJMhebAACg");
	this.shape_2.setTransform(375.5,385.7);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#000000").s().p("Ai8AAIC8iRIC9CRIi9CSgAirAAICrCFICsiFIisiEg");
	this.shape_3.setTransform(365.8,385.7);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#000000").s().p("Ai8AAIC8iRIC9CRIi9CSgAirAAICrCFICsiFIisiEg");
	this.shape_4.setTransform(384.2,385.7);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#000000").s().p("AF2J/Il4zkIlvTTIFrAAIAAARImCAAIF7z9IAUAAIGCT9g");
	this.shape_5.setTransform(384.1,256.6);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#000000").s().p("");
	this.shape_6.setTransform(269,259.6);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#000000").s().p("AirKAIAAgRICkAAIAAzdIikAAIAAgRIFXAAIAAARIikAAIAATdICkAAIAAARg");
	this.shape_7.setTransform(176.9,256.5);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#000000").s().p("Ai/J/IAAz9IARAAIAATsIFuAAIAAARg");
	this.shape_8.setTransform(124.2,256.6);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#000000").s().p("AjAKDIAA0FIGBAAIAAASIlwAAIAAJpIFwAAIAAAQIlwAAIAAJpIFwAAIAAARg");
	this.shape_9.setTransform(625.1,106.5);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#000000").s().p("AkUEWIgCAAIAAAAQhzhxAAikIAAgBIARAAIAAABQAACcBuBvQBvBtCbAAQCaAABvhtQBvhwAAibQAAibhvhuQhvhuiaAAQg6AAg4ASIgCAAIgFgRIACgBQA6gTA9AAQCiAAB0B0QB0B0AACiQAACih0BzQh0B0iiAAQihAAhzh0g");
	this.shape_10.setTransform(550.9,131.2);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#000000").s().p("Aj/D/IgDgCIABAAQhnhpAAiTQAAiVBqhqQBqhqCVAAQCWAABoBqQBqBqAACVIAAACIgSAAIAAgCQAAiOhkhkQhlhkiNAAQiNAAhlBkQhlBlAACNQAACNBlBlQBkBkCOAAQA5gBAygQIABgBIAGASIgCAAQg4ASg5AAQiVAAhqhqg");
	this.shape_11.setTransform(550.8,78.3);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#000000").s().p("AisKDIAAgRIClAAIAAzjIilAAIAAgRIFZAAIAAARIikAAIAATjICkAAIAAARg");
	this.shape_12.setTransform(478,106.5);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#000000").s().p("AjAKCIAA0DIARAAIAATyIFvAAIAAARg");
	this.shape_13.setTransform(425,106.6);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#000000").s().p("AjAKDIAA0FIGBAAIAAASIlwAAIAAJpIFwAAIAAAQIlwAAIAAJpIFwAAIAAARg");
	this.shape_14.setTransform(366.4,106.5);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#000000").s().p("AgHKUIlwz8IAAT8IgQAAIAA0nIGMAAIACAFIFwTvIAAz0IARAAIAAUngAFZKEIAXAAIl30GIgTAAgAEwKEIAXAAIly0GIgYAAgAEFKEIAZAAIly0GIgZAAgADaKEIAZAAIly0GIgZAAgACvKEIAZAAIlz0GIgYAAgACEKEIAZAAIly0GIgZAAgABbKEIAXAAIly0GIgXAAgAAvKEIAaAAIly0GIgaAAgAAGKEIAXAAIly0GIgYAAg");
	this.shape_15.setTransform(289.4,110.7);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#000000").s().p("AAHKCIAAgRIFsAAIlwzZIl5TqIgUAAIGE0DIAUAAIF9UDg");
	this.shape_16.setTransform(195.5,106.6);
	...
	this.instance.parent = this;
	this.instance.setTransform(375.1,543,1,1,0,0,0,134.8,46.6);
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(128.1,470.1,0.746,0.747,0,0,0,64.4,71);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1));

	// Mesas
	this.Mesas = new lib.Mesas();
	this.Mesas.parent = this;
	this.Mesas.setTransform(280.2,481.7,1,1,0,0,0,77,64.6);

	this.timeline.addTween(cjs.Tween.get(this.Mesas).wait(1));

	// Buffet
	this.instance_2 = new lib.Symbol4();
	this.instance_2.parent = this;
	this.instance_2.setTransform(370.1,465.6,0.746,0.747,0,0,0,57.6,65);
	...
	this.instance_3.setTransform(494.4,465.6,0.746,0.747,0,0,0,58.4,65);
	...
	this.instance_4.setTransform(623.3,465.6,0.746,0.747,0,0,0,65.7,65);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(1));

	// BG
	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#FFFFFF").s().p("Eg6lBoTMAAAjQlMB1LAAAMAAADQlg");
	this.shape_17.setTransform(375,667.5);

	this.timeline.addTween(cjs.Tween.get(this.shape_17).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(375,667.5,750,1335);
// library properties:
lib.properties = {
	width: 750,
	height: 1335,
